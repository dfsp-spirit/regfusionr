# Map MNI152 coordinates to Colin27 coordinates via fsaverage.

Convenience function that maps MNI152 RAS coordinates to Colin27 RAS
coordinates by chaining through fsaverage: MNI152 coords are first
...
then the fsaverage vertices are mapped to Colin27 coordinates using
...
``` r
mni152_coords_to_colin27_coords(
  coords,
  surface = "white",
...
nx3 numeric matrix of Colin27 RAS coordinates. Also see the 'simplify'
parameter.
