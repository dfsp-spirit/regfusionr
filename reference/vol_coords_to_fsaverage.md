...
- coords:
  ...
  which must be in MNI152/Colin27 space. The coords must be within the
  cortex, otherwise the mapping makes no sense and `NaN` values are
  returned for the respective coords.
