...
test_that("The MNI152 data projection using ANTs registration works", {
  # Load expected result data.
  ...
  out_dir = tempdir();
  outfiles = vol_to_fsaverage(input_img, out_dir, template_type='MNI152_orig', rf_type='RF_ANTs', out_type = 'curv');
